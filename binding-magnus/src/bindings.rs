...
use crate::{arenas, audio, data, error, filesystem, font, graphics, input, modshot, oneshot};
...
impl rgss::Bindings for Magnus {
    fn start(ctx: rgss::Ctx) -> std::thread::JoinHandle<()> {
